...
<div class="container">
  <div class="blog-meta-bar">
    <div class="blog-share">
      ...
      <a href="https://wa.me/?text=<?= urlencode($post['title'] . ' ' . $shareUrl) ?>" target="_blank" rel="noopener" class="share-btn share-wa" aria-label="Share on WhatsApp">
      ...
      <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($shareUrl) ?>" target="_blank" rel="noopener" class="share-btn share-fb" aria-label="Share on Facebook">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
      </a>
      <a href="https://twitter.com/intent/tweet?text=<?= urlencode($post['title']) ?>&url=<?= urlencode($shareUrl) ?>" target="_blank" rel="noopener" class="share-btn share-tw" aria-label="Share on X / Twitter">
      ...
      <button class="share-btn share-copy" id="copy-link-btn" aria-label="Copy link" title="Copy link">
    ...
    <div class="blog-meta-author">
      <?php if ($logoPath): ?>
        <img src="<?= htmlspecialchars($logoPath) ?>" alt="Hexspire Solutions" class="blog-meta-logo">
      <?php else: ?>
        <div class="blog-meta-logo-fallback">H</div>
      <?php endif; ?>
...
document.getElementById('copy-link-btn').addEventListener('click', function() {
  navigator.clipboard.writeText(window.location.href).then(() => {
    ...
    setTimeout(() => { this.title = 'Copy link'; this.style.color = ''; }, 2000);
  });
});
</script>
